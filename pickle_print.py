...
mean_DQ = pickle.load( open("pickle_files/DQ_test_cliff_walking_100N_random.p", "rb" ))
mean_Q = pickle.load( open("pickle_files/Q_test_cliff_walking_100N_random.p", "rb" ))
print(mean_Q)
